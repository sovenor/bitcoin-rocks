/**
 * Creates Punjabi (pa) inflation.json by transliterating Hindi (hi) from Devanagari to Gurmukhi
 */
const fs = require('fs');
...
const hiFile = path.join(i18nDir, 'hi', `inflation_hi.json`);
...
const paFile = path.join(i18nDir, lang, `inflation_${lang}.json`);
...
console.log('Done creating inflation.json for Punjabi (pa).');
