/**
 * Creates Punjabi (pa) index.json by transliterating Hindi (hi) from Devanagari to Gurmukhi
 */
const fs = require('fs');
...
const hiFile = path.join(i18nDir, 'hi', `index_hi.json`);
...
const paFile = path.join(i18nDir, lang, `index_${lang}.json`);
...
console.log('Done creating index.json for Punjabi (pa).');
