...
export const PAGES: readonly PageEntry[] = [
	...
	{ slug: "bitcoin-vs-crypto", phase: 7, priority: 0.8, changeFrequency: "monthly", namespace: "bitcoin-vs-crypto", published: false },
	...
	{ slug: "business/why", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/why", published: false },
	{ slug: "business/faq", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/faq", published: false },
	{ slug: "business/guide", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/guide", published: false },
	{ slug: "business/wallets", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/wallets", published: false },
	{ slug: "business/accounting", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/accounting", published: false },
	{ slug: "business/stickers", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/stickers", published: false },
	{ slug: "business/maps", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/maps", published: false },
	{ slug: "business/kit", phase: 10, priority: 0.6, changeFrequency: "monthly", namespace: "business/kit", published: false },
	{ slug: "business/kit-success", phase: 10, priority: 0.3, changeFrequency: "yearly", namespace: "business/kit-success", published: false },
	{ slug: "business/maps-success", phase: 10, priority: 0.3, changeFrequency: "yearly", namespace: "business/maps-success", published: false },
	{ slug: "business/sticker-success", phase: 10, priority: 0.3, changeFrequency: "yearly", namespace: "business/sticker-success", published: false },
	{ slug: "business/sticker-language-success", phase: 10, priority: 0.3, changeFrequency: "yearly", namespace: "business/sticker-language-success", published: false },
